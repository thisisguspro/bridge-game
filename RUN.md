# BRIDGE — Run & Getting Started

Anime-themed real-time multiplayer social-deduction game (Artemis-style bridge
command crossed with Among Us hidden-traitor play). This guide gets all the
pieces running locally so you can play.
