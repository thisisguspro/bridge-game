...
export const DEFAULT_SETTINGS = {
  audio: {
    ...
    music: 60,
    sfx: 85,
    voiceChat: 100,    // incoming proximity/energy voice volume
...
export function defaultWheels() {
  ...
  return {
    // Emote wheel binds to owned EMOTE cosmetics (starter has none equipped yet).
    emote: pad([]),
...
export function sanitizeSettings(incoming = {}) {
  ...
  out.graphics.vsync = bool(g.vsync, out.graphics.vsync);
  ...
  out.graphics.showDamageNumbers = bool(g.showDamageNumbers, out.graphics.showDamageNumbers);
